...
module.exports.config = {
  ...
  description: "সকল গ্রুপে Broadcast পাঠান (টেক্সট, ইমেজ, ভিডিও, অডিও, ফাইল সহ)",
  commandCategory: "Admin",
  usages: "/broadcast <টেক্সট> বা রিপ্লাই দিয়ে মেসেজ দিন",
  cooldowns: 5,
};
  ...
  try {
    ...
    if (event.type === "message_reply") {
      ...
      return api.sendMessage(
        "ℹ️ ব্যবহার:\n• `/broadcast <টেক্সট>`\n• বা কোনো মেসেজ রিপ্লাই দিয়ে `/broadcast` লিখুন",
        event.threadID
      );
    }

    api.sendMessage(`✅ ${successCount} টি গ্রুপে Broadcast পাঠানো হয়েছে!\n❌ ${failedCount} টি গ্রুপে পাঠানো যায়নি।`, event.threadID);
  } catch (error) {
    console.error("Global error:", error);
    api.sendMessage("❌ Broadcast পাঠাতে সমস্যা হয়েছে!", event.threadID);
  }
};
